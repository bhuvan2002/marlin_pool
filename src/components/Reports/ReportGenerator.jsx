        ...
        <div className="report-generator-unique">
            ...
            <Dialog header="Generated Report" visible={displayDialog} onHide={() => setDisplayDialog(false)} style={{ width: '70vw' }}>
                ...
                <div className="p-dialog-footer">
                    <Button label="Export as PDF" onClick={exportPdf} />
                    <Button label="Export as Excel" onClick={exportExcel} />
                    <Button label="Close" onClick={() => setDisplayDialog(false)} className="p-button-secondary" />
                </div>
            </Dialog>
        </div>
    );
